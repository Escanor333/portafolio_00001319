...
int main () 
{
  ...
  cout<<"\nla capital que tiene la mayor poblacion es: "<<y;
	...
	cout<<"\n\nDigite el nombre del tercer continente:"<<endl; cin>> cont3.nombre;
  ...
  cout<<"\nla capital que tiene la mayor poblacion es: "<<z;
	...
	cout<<"\n\nDigite el nombre del cuarto continente:"<<endl; cin>> cont4.nombre;
  ...
  //quinto continente
	...
	cout<<"\n\nDigite el nombre del quinto continente:"<<endl; cin>> cont5.nombre;
